{
    ...
    "depends": ["account"],
    "data": [
        "data/template/account.account-cr_custom.csv",
        "data/template/account.group-cr_custom.csv",
        "data/template/account.tax.group-cr_custom.csv",
        "data/template/account.tax-cr_custom.csv",
        "data/template/account.fiscal.position-cr_custom.csv",
