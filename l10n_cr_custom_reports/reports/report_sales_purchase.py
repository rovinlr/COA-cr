"""Accounting reports aligned with the Costa Rican localisation."""
...
class ReportSalesPurchase(models.AbstractModel):
    _name = 'report.l10n_cr_custom_reports.report_sales_purchase'
...
class ReportSalesPurchaseDetail(models.AbstractModel):
    _name = 'report.l10n_cr_custom_reports.report_sales_purchase_detail'
    _inherit = 'report.l10n_cr_custom_reports.report_sales_purchase'
